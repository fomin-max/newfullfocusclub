...
const FAQ: FAQItem[] = [
  ...
  { q: 'Full Focus в Махачкале — это официальный клуб сети?',
    a: 'Да, полноправный клуб сети Full Focus с теми же стандартами качества, что и в Санкт-Петербурге. Программа лояльности действует во всех 7 клубах сети.' },
  ...
  { q: 'Действует ли программа лояльности Full Focus в Махачкале?',
    a: 'Да, накопленные баллы и уровень лояльности действуют во всех 7 клубах сети — и в Махачкале, и в любом клубе Санкт-Петербурга.' },
]
