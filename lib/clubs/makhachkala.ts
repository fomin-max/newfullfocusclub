...
const media = clubMedia('makhachkala')
...
const CLUB: ClubMeta = {
  ...
  METRO: 'Центр города',
  METRO_COLOR: '#888888',
  METRO_TIME: 'ул. Манташева, 107Б',
  HOURS: 'Круглосуточно · 24/7',
  TELEGRAM: '@fullfocusmhk',
  VK: 'https://vk.com/fullfocusclub_makhachkala',
  PHONE: '+7 (993) 144-66-52',
  MAPS_URL: 'https://yandex.com/maps/-/CPDl7Lo3',
  ROUTE_URL: 'https://yandex.ru/maps/?rtext=~42.976510,47.519765&rtt=auto&ruri=~ymapsbm1%3A%2F%2Forg%3Foid%3D169594841648',
  COORDS: '42.977° N · 47.520° E',
  VIDEO_URL: media.video,
  VIDEO_URL_DESKTOP: media.videoDesktop,
  POSTER_URL: media.poster,
  VIDEO_TITLE: 'Full Focus Махачкала — обзор компьютерного клуба',
  VIDEO_DESC: 'Видеообзор компьютерного клуба Full Focus в Махачкале. Игровые зоны, оборудование, атмосфера.',
  ...
  GEO: { lat: 42.976510, lng: 47.519765 },
...
const CLUB_ZONES: ClubZone[] = [
  { id: 'bootcamp', name: 'BOOTCAMP ×2', accent: '#6632FA', seats: '5+5', priceFrom: 170,
    ...
    desc: 'Два отдельных BOOTCAMP по 5 мест каждый. RTX 5060, мониторы 240Hz, голосовая связь.',
    specShort: 'RTX 5060 · 27" 240Hz · 2×5 мест', image: '/clubs/makhachkala/zones/bootcamp.jpg',
    cta: 'ЗАБРОНИРОВАТЬ', flagship: false },
  { id: 'quadro',   name: 'QUADRO ROOM', accent: '#6632FA', seats: 4, priceFrom: 200,
    desc: 'Уникальная зона на 4 места — нигде в сети Full Focus нет такого формата. RTX 5060 Ti, 27" 2K 300Hz.',
    specShort: 'RTX 5060 Ti · 27" 2K 300Hz · 4 места', image: '/clubs/makhachkala/zones/quadro.jpg',
    cta: 'ЗАБРОНИРОВАТЬ', flagship: false, wide: false },
  { id: 'trio',     name: 'TRIO ROOM',  accent: '#6632FA', seats: 3, priceFrom: 260,
    desc: 'Приватная комната на троих. RTX 5070, 380Hz, кресла Knight Gladiator.',
    specShort: 'RTX 5070 · 24.5" 380Hz · Knight', image: '/clubs/makhachkala/zones/trio.jpg',
    cta: 'ЗАБРОНИРОВАТЬ', flagship: false, wide: false },
  { id: 'duo',      name: 'DUO ROOM',  accent: '#6632FA', seats: 2, priceFrom: 280,
    desc: 'Приватная комната на двоих. RTX 5070, 27" 2K 300Hz, кресла Knight Craft.',
    specShort: 'RTX 5070 · 27" 2K 300Hz · Knight', image: '/clubs/makhachkala/zones/duo.jpg',
    cta: 'ЗАБРОНИРОВАТЬ', flagship: false, wide: false },
  { id: 'solo',     name: 'SOLO ROOM', accent: '#6632FA', seats: 1, priceFrom: 320,
    desc: 'Полная изоляция. RTX 5070, 380Hz, Logitech Superlight 2 — лучшее железо в клубе.',
    specShort: 'RTX 5070 · 24.5" 380Hz · Knight', image: '/clubs/makhachkala/zones/solo.jpg',
    cta: 'ЗАБРОНИРОВАТЬ', flagship: false, wide: false },
  { id: 'ps5',      name: 'PS5 LOUNGE',    accent: '#00FFB6', seats: 'до 5', priceFrom: 350,
    desc: 'PS5 с большим TV. Кооперативы, файтинги и весь каталог PlayStation 5.',
    specShort: 'PS5 · TV', image: '/clubs/makhachkala/zones/ps5.jpg',
    cta: 'ЗАБРОНИРОВАТЬ', flagship: false, wide: false },
  { id: 'ps5vip',   name: 'PS5 VIP LOUNGE', accent: '#00FFB6', seats: 'до 6', priceFrom: 400,
    ...
    specShort: 'PS5 · TV · большой диван', image: '/clubs/makhachkala/zones/ps5vip.jpg',
    cta: 'ЗАБРОНИРОВАТЬ', flagship: false, wide: false },
]
...
const HARDWARE: ClubData['HARDWARE'] = {
  bootcamp: { name: 'BOOTCAMP', rows: [
    { k: 'Видеокарта', v: 'NVIDIA GeForce RTX 5060', accent: true },
    { k: 'Процессор',  v: 'Intel Core i5-14400F' },
    { k: 'Монитор',    v: 'ASUS TUF Gaming 27" · 240 Hz', accent: true },
    { k: 'Мышка',      v: 'Ajazz AJ159 Apex' },
    { k: 'Наушники',   v: 'HyperX Cloud II' },
    { k: 'Кресло',     v: 'Knight Gladiator' },
    { k: 'Клавиатура', v: 'Ajazz AK820 Max' },
  ]},
  quadro: { name: 'QUADRO ROOM', rows: [
    { k: 'Видеокарта', v: 'NVIDIA GeForce RTX 5060 Ti', accent: true },
    { k: 'Процессор',  v: 'Intel Core i5-14400F' },
    { k: 'Монитор',    v: 'ASUS TUF Gaming 27" 2K · 300 Hz', accent: true },
    { k: 'Мышка',      v: 'Ajazz AJ159 Apex' },
    { k: 'Наушники',   v: 'HyperX Cloud II' },
    { k: 'Кресло',     v: 'Knight Gladiator' },
    { k: 'Клавиатура', v: 'Ajazz AK820 Max Ultra' },
  ]},
  trio: { name: 'TRIO ROOM', rows: [
    { k: 'Видеокарта', v: 'NVIDIA GeForce RTX 5070', accent: true },
    { k: 'Процессор',  v: 'Intel Core i5-14400F' },
    { k: 'Монитор',    v: 'ASUS ROG Strix 24.5" · 380 Hz', accent: true },
    { k: 'Мышка',      v: 'Logitech Superlight 2', accent: true },
    { k: 'Наушники',   v: 'HyperX Cloud III Wireless' },
    { k: 'Кресло',     v: 'Knight Gladiator' },
    { k: 'Клавиатура', v: 'Ajazz AK820 Max Ultra' },
  ]},
  duo: { name: 'DUO ROOM', rows: [
    { k: 'Видеокарта', v: 'NVIDIA GeForce RTX 5070', accent: true },
    { k: 'Процессор',  v: 'Intel Core i5-14600KF', accent: true },
    { k: 'Монитор',    v: 'ASUS TUF Gaming 27" 2K · 300 Hz', accent: true },
    { k: 'Мышка',      v: 'Logitech Superlight 2', accent: true },
    { k: 'Наушники',   v: 'HyperX Cloud III Wireless' },
    { k: 'Кресло',     v: 'Knight Craft' },
    { k: 'Клавиатура', v: 'Ajazz AK820 Max Ultra' },
  ]},
...
const FEATURES: Feature[] = [
  { id: 'unique',  size: 'big',   name: 'ЕДИНСТВЕННЫЙ FF В ДАГЕСТАНЕ',
    ...
    image: '/clubs/makhachkala/features/unique.jpg', tag: 'Первый в Дагестане', icon: null, note: null },
  { id: 'quadro',  size: 'wide',  name: 'QUADRO ROOM — ТОЛЬКО ЗДЕСЬ',
    desc: 'Уникальная зона на 4 места — нигде в сети Full Focus нет такого формата. RTX 5060 Ti, 27" 2K 300Hz. Для четвёрки игроков.',
  ...
  { id: 'prayer',  size: 'small', name: 'МОЛЕЛЬНАЯ КОМНАТА',
    desc: 'Отдельное помещение для намаза — для комфорта наших гостей.',
    icon: 'star', image: null, tag: 'Только здесь', note: null },
