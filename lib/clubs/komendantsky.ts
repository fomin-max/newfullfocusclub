...
const CLUB_ZONES: ClubZone[] = [
  ...
  { id: 'max',     name: 'MAX ZONE',      accent: '#6632FA', seats: 10, priceFrom: 190,
    desc: 'Улучшенные конфигурации — RTX 4080, DDR5, 27" 165Hz. Для тех, кому нужна максимальная производительность.',
  ...
  { id: 'bootcamp', name: 'BOOTCAMP',     accent: '#6632FA', seats: 5, priceFrom: 240,
    desc: 'Зона для команды или подготовки к турниру. Голосовая связь и оборудование для трансляций.',
  ...
  { id: 'ps5vip',  name: 'PS5 VIP LOUNGE', accent: '#00FFB6', seats: 'до 6', priceFrom: 500,
    ...
    specShort: 'PS5 · 65" TV · отдельная комната', image: '/assets/club-interior.jpg',
    cta: 'ЗАБРОНИРОВАТЬ', flagship: false, wide: false },
]
...
const HARDWARE: ClubData['HARDWARE'] = {
  ...
  ps5: { name: 'PS5 LOUNGE', rows: [
    ...
    { k: 'Посадка',    v: 'Кресла + мягкий диван' },
    { k: 'Игры',       v: 'Полная библиотека PS Store' },
  ]},
}
...
const FEATURES: Feature[] = [
  ...
  { id: 'max10',  size: 'wide',  name: 'MAX ZONE — RTX 4080',
    desc: '10 мест с RTX 4080, DDR5 и 27" 165Hz. Для тех, кому нужен настоящий максимум.',
  ...
  { id: 'metro',  size: 'small', name: '7 МИН ОТ МЕТРО',
    desc: 'Комендантский проспект — 7 минут пешком от выхода из метро.',
...
const REVIEWS: Review[] = [
  ...
  { name: 'Сергей Л.', src: 'Яндекс', stars: 5, text: 'Хожу после работы — удобно, 7 минут от метро Комендантский. Всё чисто, уютно.' },
...
const FAQ: FAQItem[] = [
  ...
  { q: 'Где находится клуб Full Focus на Комендантском?',
    a: 'Проспект Испытателей, 33, Санкт-Петербург. 7 минут пешком от метро Комендантский проспект (фиолетовая линия). Координаты: 60.009° N, 30.258° E.' },
  ...
  { q: 'Как добраться до Full Focus на Комендантском?',
    a: '7 минут пешком от метро Комендантский проспект по проспекту Испытателей.' },
