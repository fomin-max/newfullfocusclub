...
const CLUB: ClubMeta = {
  ...
  FEATURES_SUB:   'Самые низкие цены в сети Full Focus. Идеально для студентов — от 120₽/час и два PS-лаунжа, которых нет в других клубах.',
  MAP: {
    pin:   { top: '50%', left: '46%' },
    river: false,
    roads: [
...
const CLUB_ZONES: ClubZone[] = [
  { id: 'pro',   name: 'PRO ZONE',      accent: '#6632FA', seats: 6,  priceFrom: 120,
    desc: 'Игровые ПК с RTX 4070 по самым доступным ценам в сети. 6 мест в уютной атмосфере.',
    specShort: 'RTX 4070 · 165Hz · от 120₽', image: '/assets/club-interior.jpg',
    cta: 'ЗАБРОНИРОВАТЬ', flagship: false, wide: false },
  { id: 'bootcamp', name: 'BOOTCAMP',   accent: '#6632FA', seats: 6,  priceFrom: 170,
    desc: 'Командная зона на 6 мест — голосовая связь и железо для командных игр.',
    specShort: 'RTX 4070 · 144Hz · 6 мест', image: '/assets/club-background.jpg',
    cta: 'ЗАБРОНИРОВАТЬ', flagship: false, wide: false },
  { id: 'max',   name: 'MAX ZONE',      accent: '#6632FA', seats: 4,  priceFrom: 190,
    desc: 'Топовые конфигурации — RTX 4080, DDR5, 27" 165Hz. Максимум производительности по доступной цене.',
  ...
  { id: 'trio',  name: 'TRIO ROOM',     accent: '#6632FA', seats: 3,  priceFrom: 220,
    desc: 'Приватная комната на троих. Тишина, своё пространство, Noblechairs.',
  ...
  { id: 'solo',  name: 'SOLO ROOM',     accent: '#6632FA', seats: 1,  priceFrom: 250,
    desc: 'Один на один с игрой. Полная изоляция и лучшее железо для ранкеда.',
    specShort: 'RTX 4080 · 27" 165Hz · Noblechairs', image: '/assets/club-background.jpg',
    cta: 'ЗАБРОНИРОВАТЬ', flagship: false, wide: false },
  { id: 'ps4',   name: 'PS4 PRO LOUNGE', accent: '#00D4FF', seats: '4 кресла', priceFrom: 280,
    ...
    specShort: 'PS4 Pro · 55" TV · 4 кресла', image: '/assets/club-interior.jpg',
    cta: 'ЗАБРОНИРОВАТЬ', flagship: false },
  { id: 'ps5',   name: 'PS5 LOUNGE',    accent: '#00FFB6', seats: '4 кресла', priceFrom: 380,
...
const HARDWARE: ClubData['HARDWARE'] = {
  ...
  max: { name: 'MAX ZONE', rows: [
    ...
    { k: 'Монитор',    v: '27" · 165 Hz', accent: true },
    { k: 'Кресло',     v: 'Noblechairs Hero', accent: true },
    { k: 'Периферия',  v: 'Razer Pro' },
  ]},
  rooms: { name: 'TRIO / SOLO ROOM', rows: [
  ...
  ps: { name: 'PS4 PRO / PS5 LOUNGE', rows: [
    ...
    { k: 'Консоль PS4', v: 'Sony PS4 Pro (уникально)', accent: true },
...
const FEATURES: Feature[] = [
  { id: 'price',  size: 'big',   name: 'ОТ 120₽/ЧАС — ДЕШЕВЛЕ В СЕТИ НЕТ',
    desc: 'PRO ZONE от 120₽/час — самый доступный тариф среди всех клубов Full Focus. Студентам и школьникам пн-пт 10:00–16:00.',
    image: '/assets/club-interior.jpg', tag: 'Лучшая цена', icon: null, note: null },
  { id: 'ps4',   size: 'wide',  name: 'PS4 PRO LOUNGE — УНИКАЛЬНО В СЕТИ',
    desc: 'Единственный клуб с PlayStation 4 Pro и отдельным TV 55". Обширная классическая библиотека игр по доступной цене.',
    icon: 'gamepad', image: null, tag: 'Только здесь', note: null },
  ...
  { id: 'solo',  size: 'small', name: 'SOLO ROOM',
    desc: 'Изолированная комната для ранкеда. RTX 4080, Noblechairs, тишина.',
    icon: 'sofa', image: null, tag: null, note: null },
  { id: 'student', size: 'small', name: 'СКИДКИ СТУДЕНТАМ',
    desc: 'Школьникам и студентам — PRO ZONE от 120₽/час в будни с 10:00 до 16:00.',
    icon: 'school', image: null, tag: null, note: null },
